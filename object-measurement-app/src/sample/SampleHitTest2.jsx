...
import './sample-hit-test-2.css';

const SampleHitTest2 = () => {
  ...
  const addReticleToScene = () => {
    ...
    // we start with the reticle not visible
  ...
  return (
    <div>SampleHitTest2</div>
  );
};

SampleHitTest2.propTypes = {};

export default SampleHitTest2;